...
<p>进入</p>
<p><a href="?page=ucp"><span>控制面板</span></a></p>
</div>
<div class="cp-item wow shake last">
<?php if(isset($_SESSION['cw_user'])) { ?>
<a href='?page=logout&last_page=<?php echo $_SERVER["REQUEST_URI"]; ?>'><span class="ico-exit"></span></a>
<?php } ?>
</div>
</div>
</div>
...
<div class="">
<h3 class="title">
<a href="?page=news/183-Dark+Portal+Opening+Event">
黑暗之门开启事件 </a>
</h3>
<div class="content">
8月11日-格林尼治时间下午7点+2
...
<a href="?page=news/183-Dark+Portal+Opening+Event" class="btn">阅读全文</a>
</div>
</article>
...
<h3 class="title">
<a href="?page=news/182-Important%21+TBC+Release+Announcement%2C+timeline+inside%21">
重要!TBC发布公告，时间线在里面! </a>
</h3>
<div class="content">
...
<div class="readmore">
<div class="fadeout"></div>
<a href="?page=news/182-Important%21+TBC+Release+Announcement%2C+timeline+inside%21" class="btn">阅读全文</a>
</div>
</article>
...
<div class="readmore">
<div class="fadeout"></div>
<a href="?page=news/180-News%3A" class="btn">阅读全文</a>
</div>
</article>
</div>
<div class="readmore">
<a href="?page=news">所有新闻</a></div>
</div>
</section>
</div>
</div>
