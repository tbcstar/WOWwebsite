...
$asql = "SELECT SUM(online) FROM characters WHERE race IN(1,3,4,7,11,22)";
$asqlquery = mysql_query($asql) or die(mysql_error());
$amemb = mysql_result($asqlquery,0,0);  

$hsql = "SELECT SUM(online) FROM characters WHERE race IN(2,5,6,8,9,10)";
...
<h2>服务器统计信息</h2>
<table class="spoiler">
<p>注册帐户: <?php echo ''.$acc.''; ?></p>
<p>当前在线数：<?php echo ''.$daa4.''; ?></p>
<p>今日创建账户: <?php echo ''.$daa3.''; ?></p>

<br>
<table class="spoiler">
<center><img src="/themes/nefelin/images/bc.gif" width="50">
<h2>实时服务器信息</h2></center>
<tr>
<th>服务器</th>
<th>状态</th>
<th>在线人数</th>
...
<tr>
<td><a href="game.tbcstar.com" class="spoiler-button">时光回溯</a></td>
<td>在线</td>
<td><?php echo $memb; ?></td>
<td><?php echo "$mx"; ?></td>
<td><?php echo ''.$char.''; ?></td>
